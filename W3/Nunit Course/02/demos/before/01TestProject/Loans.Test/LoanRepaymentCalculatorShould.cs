...
namespace Loans.Test
{
    class LoanRepaymentCalculatorShould
    {
        ...
        public decimal CalulateCorrectMonthlyRepayment_SimplifiedTestCase(decimal pricipal, decimal interestRate, int termInYears)
        {
           var sut = new LoanRepaymentCalculator();

           return sut.CalculateMonthlyRepayment(new LoanAmount("USD", pricipal), interestRate, new LoanTerm(termInYears));
            
        }

        [Test]
        [TestCaseSource(typeof(MontlyRepaymentTestData), "TestCases")]
        public void CalulateCorrectMonthlyRepayment_Centralized(decimal pricipal, decimal interestRate, int termInYears, decimal expectedMonthlyPayment)
        {
            var sut = new LoanRepaymentCalculator();
        ...
        public decimal CalulateCorrectMonthlyRepayment_Centralized_With_Return(decimal pricipal, decimal interestRate, int termInYears)
        {
            var sut = new LoanRepaymentCalculator();
        ...
        [Test]
        [TestCaseSource(typeof(MontlyRepaymentCsvData), "GetTestCases", new object[] {"Data.csv"})]
        public void CalulateCorrectMonthlyRepayment_Csv(decimal pricipal, decimal interestRate, int termInYears, decimal expectedMonthlyPayment)
        {
            var sut = new LoanRepaymentCalculator();
        ...
        [Test]
        public void CalulateCorrectMonthlyRepayment_Combinatorial(
        ...
        [Test]
        [Sequential]
        public void CalulateCorrectMonthlyRepayment_Sequential(
        ...
        [Test]
        public void CalulateCorrectMonthlyRepayment_Range(
